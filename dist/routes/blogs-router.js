...
exports.blogsRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let allBlogs = yield blogs_repository_1.blogsRepository.returnAllBlogs();
    res.status(200).send(allBlogs);
    return;
}))
    .get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let blog = yield blogs_repository_1.blogsRepository.getBlogsById(req.params.id);
    if (blog) {
    ...
    const isUpdated = yield blogs_repository_1.blogsRepository.updateBlog(id, req.body);
    if (isUpdated) {
        res.sendStatus(204);
    }
    else
    ...
    const id = req.params.id;
    const isDeleted = yield blogs_repository_1.blogsRepository.deleteBlog(id);
    if (isDeleted) {
        res.sendStatus(204);
    }
    else
